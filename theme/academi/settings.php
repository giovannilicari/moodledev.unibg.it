...
if (is_siteadmin()) {
	...
	$name = 'theme_academi/emailid1';
	$title = get_string('emailid1', 'theme_academi');
	$description = '';
	$default = get_string('defaultemailid1', 'theme_academi');
	$setting = new admin_setting_configtext($name, $title, $description, $default);
	$temp->add($setting);
	...
	$description = '';
	$default = get_string('defaultemailid2', 'theme_academi');
	$setting = new admin_setting_configtext($name, $title, $description, $default);
	$temp->add($setting);
	...
	$name = 'theme_academi/igurl';
	$title = get_string('igurl', 'theme_academi');
	$description = get_string('igurldesc', 'theme_academi');
	$default = get_string('igurl_default', 'theme_academi');
	$setting = new admin_setting_configtext($name, $title, $description, $default);
	$temp->add($setting);

	$name = 'theme_academi/lkurl';
	$title = get_string('lkurl', 'theme_academi');
	$description = get_string('lkurldesc', 'theme_academi');
	$default = get_string('lkurl_default', 'theme_academi');
	$setting = new admin_setting_configtext($name, $title, $description, $default);
	$temp->add($setting);
