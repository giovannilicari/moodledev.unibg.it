...
$semail1 = get_string('email1', 'theme_academi');
$semail2 = get_string('email2', 'theme_academi');
...
$igurl = theme_academi_get_setting('igurl');
$lkurl = theme_academi_get_setting('lkurl');
$address = theme_academi_get_setting('address');
$emailid = theme_academi_get_setting('emailid');
$emailid1 = theme_academi_get_setting('emailid1');
...
$email1 = get_string('email1', 'theme_academi');
$email2 = get_string('email2', 'theme_academi');
$sfollowus = get_string('followus', 'theme_academi');

$url = ($fburl != '' || $pinurl != '' || $twurl != '' || $gpurl != '' || $igurl != '' || $lkurl != '' ) ? 1 : 0;
$block3 = ($address != '' || $phoneno != '' || $emailid != '' || $emailid1 != '' || $emailid2 != '' || $url != 0) ? 1 : 0;
